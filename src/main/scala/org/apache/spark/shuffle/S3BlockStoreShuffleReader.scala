...
import org.apache.spark.storage.{BlockId, BlockManager, BlockManagerId, S3ShuffleBlockFetcherIterator}
import org.apache.spark.util.CompletionIterator
import org.apache.spark.util.collection.ExternalSorter

/** Fetches and reads the blocks from a shuffle by requesting them from other nodes' block stores.
  */
private[spark] class S3BlockStoreShuffleReader[K, C](
  ...
  override def read(): Iterator[Product2[K, C]] = {
    val wrappedStreams = new S3ShuffleBlockFetcherIterator(
      context,
